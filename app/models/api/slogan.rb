class Api::Slogan < ApplicationRecord
  ...
  validates :first_name, presence: {message: "Your first name cannot be blank"}, length: {
                           in: 3..20,
                           too_short: "Your first name is too short.",
                           too_long: "Your first name is too long (%{count} characters max).",
                         }

  validates :last_name, presence: {message: "Your last name cannot be blank"}, length: {
                          in: 3..40,
                          too_short: "Your last name is too short.",
                          too_long: "Your last name is too long (%{count} characters max).",
                        }

  validates :slogan, presence: {message: "Your slogan cannot be blank"}, length: {
                       in: 3..50,
